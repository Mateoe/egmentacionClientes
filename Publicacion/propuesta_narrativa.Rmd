...
A continuación se presentan las conclusiones generales de lo evidenciado en el [análisis exploratorio de variables en_vm_canalX](https://www.google.com), haciendo uso de la tabla que reúne todos los resultados de los resumenes numéricos.
</div>
...
A continuación se presentan las conclusiones generales de lo evidenciado en el [análisis exploratorio de variables en_tx_canalX](https://www.google.com), haciendo uso de la tabla que reúne todos los resultados de los resumenes numéricos.
</div>
...
A continuación se presentan las conclusiones generales de lo evidenciado en el [análisis exploratorio de variables sal_vm_canalX y sal_tx_canalX](https://www.google.com).
</div>
...
Todo lo mencionado previamente se encuentra disponible en el siguiente enlace: [análisis exploratorio - estados financieros y características](https://www.google.com).
